...
module Cadmium
  ...
  class NounInflector < TenseInflector
    def initialize
      ...
      plural_forms.regular_forms.push({/([^v])y$/i, "\\1ies"})
      plural_forms.regular_forms.push({/(criteri|phenomen|automat)on$/i, "\\1a"})
      plural_forms.regular_forms.push({/(curricul|dat|medi|memorand|bacteri|errat|ov|agend|referend|spectr|strat)um$/i, "\\1a"})
      plural_forms.regular_forms.push({/(antenn|formul|nebul|vertebr|vit)a$/i, "\\1ae"})
      plural_forms.regular_forms.push({/([aeiou]l|ar|ea|oo)f$/i, "\\1ves"})
      ...
      plural_forms.regular_forms.push({/(quiz)$/i, "\\1zes"})
      plural_forms.regular_forms.push({/(sis)$/i, "ses"})
      plural_forms.regular_forms.push({/(matr|vert|ind|cort)(ix|ex)$/i, "\\1ices"})
      plural_forms.regular_forms.push({/(bureau|tableau|chateau|plateau)$/i, "\\1x"})
      ...
      # Most specific patterns first - order matters!
      singular_forms.regular_forms.push({/(.*[^us])ses$/i, "\\1se"})
      singular_forms.regular_forms.push({/([^v])ies$/i, "\\1y"})
      singular_forms.regular_forms.push({/(criteri|phenomen|automat)a$/i, "\\1on"})
      singular_forms.regular_forms.push({/(curricul|dat|medi|memorand|bacteri|errat|ov|agend|referend|spectr|strat)a$/i, "\\1um"})
      singular_forms.regular_forms.push({/(antenn|formul|nebul|vertebr|vit)ae$/i, "\\1a"})
      singular_forms.regular_forms.push({/([aeiou]l|ar|ea|oo)ves$/i, "\\1f"})
      ...
      singular_forms.regular_forms.push({/(quiz)zes$/i, "\\1"})
      ...
      singular_forms.regular_forms.push({/(bureau|tableau|chateau|plateau)x$/i, "\\1"})
